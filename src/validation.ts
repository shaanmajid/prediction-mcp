...
// Schema for polymarket_get_last_trade_price
export const PolymarketGetLastTradePriceArgsSchema = z
  .object({
    token_id: z
      .string()
      .min(1)
      .describe(
        "Outcome token ID from market's clobTokenIds field. Returns the last executed trade price for this token.",
      ),
  })
  .strict();
...
>;
export type PolymarketGetLastTradePriceArgs = z.infer<
  typeof PolymarketGetLastTradePriceArgsSchema
>;
